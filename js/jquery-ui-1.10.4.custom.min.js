...
(function(e, t) {
    ...
    e.fn.position = function(t) {
        ...
        this.each(function() {
            ...
            "bottom" === t.my[1] ? C.top -= d : "center" === t.my[1] && (C.top -= d / 2),
            C.left += M[0],
            C.top += M[1],
            e.support.offsetFractions || (C.left = h(C.left),
            C.top = h(C.top)),
            n = {
                marginLeft: f,
                marginTop: _
            ...
            t.using && (l = function(e) {
                ...
                c > p && p > r(i + s) && (h.horizontal = "center"),
    ...
    e.ui.position = {
        ...
        flip: {
            ...
            top: function(e, t) {
                ...
                e.top + p + f + m > u && (0 > s || r(u) > s) && (e.top += p + f + m)) : c > 0 && (i = e.top - t.collisionPosition.marginTop + p + f + m - h,
                e.top + p + f + m > c && (i > 0 || c > r(i)) && (e.top += p + f + m))
            }
        },
        flipfit: {
            left: function() {
...
(function(e) {
    ...
    e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, i) {
            var s, n, a, o, r, h, l, u, c, d, p = e(this).data("ui-draggable"), f = p.options, m = f.snapTolerance, g = i.offset.left, v = g + p.helperProportions.width, _ = i.offset.top, y = _ + p.helperProportions.height;
            for (c = p.snapElements.length - 1; c >= 0; c--)
                r = p.snapElements[c].left,
                h = r + p.snapElements[c].width,
                l = p.snapElements[c].top,
                u = l + p.snapElements[c].height,
                r - m > v || g > h + m || l - m > y || _ > u + m || !e.contains(p.snapElements[c].item.ownerDocument, p.snapElements[c].item) ? (p.snapElements[c].snapping && p.options.snap.release && p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), {
                ...
                d = s || n || a || o,
                "outer" !== f.snapMode && (s = m >= Math.abs(l - _),
                n = m >= Math.abs(u - y),
                a = m >= Math.abs(r - g),
                o = m >= Math.abs(h - v),
                s && (i.position.top = p._convertPositionTo("relative", {
...
(function(e) {
    ...
    e.ui.intersect = function(e, i, s) {
        ...
        case "pointer":
            ...
            t(a, c, i.proportions().height) && t(n, u, i.proportions().width);
        case "touch":
...
(function(e) {
    ...
    e.ui.plugin.add("resizable", "grid", {
        resize: function() {
            ...
            t.position.top = a.top - c) : (t.size.height = l,
            t.position.top = a.top + n.height - l),
            d - h > 0 ? (t.size.width = d,
            ...
            if (f)
                if (1 === this.containers.length)
                    ...
                    a = this.items.length - 1; a >= 0; a--)
                        e.contains(this.containers[m].element[0], this.items[a].item[0]) && this.items[a].item[0] !== this.currentItem[0] && (!p || t(this.positionAbs.top + this.offset.click.top, this.items[a].top, this.items[a].height)) && (c = this.items[a].item.offset()[h],
                        d = !1,
                        Math.abs(c - u) > Math.abs(c + this.items[a][l] - u) && (d = !0,
                        c += this.items[a][l]),
                        o > Math.abs(c - u) && (o = Math.abs(c - u),
                        r = this.items[a],
...
(function(e, t) {
    ...
    e.extend(i.prototype, {
        ...
        _optionDatepicker: function(i, s, a) {
            ...
            return 2 === arguments.length && "string" == typeof s ? "defaults" === s ? e.extend({}, e.datepicker._defaults) : u ? "all" === s ? e.extend({}, u.settings) : this._get(u, s) : null : (o = s || {},
            "string" == typeof s && (o = {},
            o[s] = a),
            ...
            n(u.settings, o),
            null !== h && o.dateFormat !== t && o.minDate === t && (u.settings.minDate = this._formatDate(u, h)),
            null !== l && o.dateFormat !== t && o.maxDate === t && (u.settings.maxDate = this._formatDate(u, l)),
        ...
        _doKeyPress: function(i) {
            ...
            return e.datepicker._get(a, "constrainInput") ? (s = e.datepicker._possibleChars(e.datepicker._get(a, "dateFormat")),
            n = String.fromCharCode(null == i.charCode ? i.keyCode : i.charCode),
            i.ctrlKey || i.metaKey || " " > n || !s || s.indexOf(n) > -1) : t
        },
        _doKeyUp: function(t) {
        ...
        _updateDatepicker: function(t) {
            ...
            n > 1 && t.dpDiv.addClass("ui-datepicker-multi-" + n).css("width", o * n + "em"),
        ...
        _hideDatepicker: function(t) {
            ...
            ,
            e.effects && (e.effects.effect[i] || e.effects[i]) ? r.dpDiv.hide(i, e.datepicker._get(r, "showOptions"), s, n) : r.dpDiv["slideDown" === i ? "slideUp" : "fadeIn" === i ? "fadeOut" : "hide"](i ? s : null, n),
            i || n(),
            this._datepickerShowing = !1,
        ...
        parseDate: function(i, s, n) {
            ...
            "" === s)
                return null;
            var a, o, r, h, l = 0, u = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff, c = "string" != typeof u ? u : (new Date).getFullYear() % 100 + parseInt(u, 10), d = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, p = (n ? n.dayNames : null) || this._defaults.dayNames, f = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, m = (n ? n.monthNames : null) || this._defaults.monthNames, g = -1, v = -1, _ = -1, y = -1, b = !1, x = function(e) {
                ...
                if (e.each(r, function(e, i) {
                    var n = i[1];
                    return s.substr(l, n.length).toLowerCase() === n.toLowerCase() ? (o = i[0],
                    l += n.length,
                    !1) : t
                }),
                -1 !== o)
            ...
            y > -1)
                for (v = 1,
                _ = y; ; ) {
                    if (o = this._getDaysInMonth(g, v - 1),
                    o >= _)
                        break;
                    v++,
                    _ -= o
        ...
        _generateHTML: function(e) {
            ...
            et--),
            $)
                for (t = this._daylightSavingAdjust(new Date($.getFullYear(),$.getMonth() - q[0] * q[1] + 1,$.getDate())),
            ...
            w = 0; q[0] > w; w++) {
                ...
                D = 0; q[1] > D; D++) {
                    ...
                    C = "",
                    G) {
                        if (C += "<div class='ui-datepicker-group",
                        q[1] > 1)
                            switch (D) {
                            case 0:
                    ...
                    for (C += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + M + "'>" + (/all|left/.test(M) && 0 === w ? Y ? a : s : "") + (/all|right/.test(M) && 0 === w ? Y ? s : a : "") + this._generateMonthYearHeader(e, Z, et, X, $, w > 0 || D > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + "<tr>",
                    S = c ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "",
                    x = 0; 7 > x; x++)
                        N = (x + u) % 7,
                        S += "<th" + ((x + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + ">" + "<span title='" + d[N] + "'>" + p[N] + "</span></th>";
                    for (C += S + "</tr></thead><tbody>",
                    ...
                    E = 0; H > E; E++) {
                        for (C += "<tr>",
                        F = c ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(z) + "</td>" : "",
                        x = 0; 7 > x; x++)
                            O = g ? g.apply(e.input ? e.input[0] : null, [z]) : [!0, ""],
                            W = z.getMonth() !== Z,
                            j = W && !_ || !O[0] || X && X > z || $ && z > $,
                            F += "<td class='" + ((x + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (z.getTime() === T.getTime() && Z === e.selectedMonth && e._keyEvent || y.getTime() === z.getTime() && y.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (j ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + O[1] + (z.getTime() === Q.getTime() ? " " + this._currentClass : "") + (z.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !O[2] ? "" : " title='" + O[2].replace(/'/g, "&#39;") + "'") + (j ? "" : " data-handler='selectDay' data-event='click' data-month='" + z.getMonth() + "' data-year='" + z.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : j ? "<span class='ui-state-default'>" + z.getDate() + "</span>" : "<a class='ui-state-default" + (z.getTime() === R.getTime() ? " ui-state-highlight" : "") + (z.getTime() === Q.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + z.getDate() + "</a>") + "</td>",
                    ...
                    Z > 11 && (Z = 0,
                    et++),
                    C += "</tbody></table>" + (G ? "</div>" + (q[0] > 0 && D === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""),
                    k += C
                }
                b += k
            }
...
(function(e) {
    e.effects.effect.drop = function(t, i) {
        var s, n = e(this), a = ["position", "top", "bottom", "left", "right", "opacity", "height", "width"], o = e.effects.setMode(n, t.mode || "hide"), r = "show" === o, h = t.direction || "left", l = "up" === h || "down" === h ? "top" : "left", u = "up" === h || "left" === h ? "pos" : "neg", c = {
            opacity: r ? 1 : 0
        };
        e.effects.save(n, a),
        n.show(),
...
(function(e) {
    ...
    e.effects.effect.size = function(t, i) {
        ...
        o.find("*[width]").each(function() {
            ...
            a.from.y !== a.to.y && (i.from = e.effects.setTransition(i, c, a.from.y, i.from),
            i.to = e.effects.setTransition(i, c, a.to.y, i.to)),
            a.from.x !== a.to.x && (i.from = e.effects.setTransition(i, d, a.from.x, i.from),
